...
class GirofeedsLogger
{
    ...
    /**
     * GirofeedsLogger constructor.
     */
    public function __construct()
    {
        $this->loglevel = (int) Configuration::get('GIROFEEDS_LOGLEVEL');
    }
    ...
    public function addLog(
        ...
        if ($this->loglevel >= $loglevel) {
            ...
            if ($loglevel == 1) {
                PrestaShopLogger::addLog($message, 3, null, 'Girofeeds');
            }
            if ($exception) {
    ...
    {
        return $this->getLogDir() . 'girofeeds.log';
    }

    /**
     * @return GirofeedsLogger
     */
