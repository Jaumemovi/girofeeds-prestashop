...
class GirofeedsProductModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        if (Tools::getValue('id_product')) {
            ...
            if (!$id_product) {
                ...
                $product = new GirofeedsProduct((int) $id_product, true);
                ...
                $json['product'] = GirofeedsProduct::prepareFieldsForFeed($json['product']);
                ...
                if (isset($json['product']['id_category_default'])) {
                    ...
                    $json['product']['category_default'] = $category->name[$this->context->language->id];
                }
